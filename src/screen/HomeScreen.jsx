        ...
        <div style={{ width: 1000 }} className="flex mx-auto justify-center">
          <div className="flex flex-col items-center ">
            ...
            <p className="text-2xl text-center" style={{ width: 400 }}>
              Housekeeping ensures a clean, organized living space, promoting comfort and well-being. It involves tasks
              like cleaning, tidying, and maintaining a hygienic environment.
            </p>
          </div>
          <div className="flex flex-col items-center ">
